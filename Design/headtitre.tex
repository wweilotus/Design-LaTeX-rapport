...
\lefoot{\color{darkgray}\small \today}
\rofoot{\color{darkgray}\small \today}
...
\vspace{1cm}
\begin{center}
 \textsc{\LARGE 北京理工大学\\ \large 宇航学院 \\ \depa\unskip\strut} \vspace{-1.5ex} \\	
\end{center}
\vspace{3cm}
...
\begin{minipage}[t]{0.5\textwidth}
    \begin{flushright}
        {\large \textit{导师}\superv\unskip\strut}           
        \vspace*{0.5cm}
    \end{flushright}    
\end{minipage}%
